...
class simpleReactor(tk.Frame):
    ...
    def __init__(self, master, species_tab) -> None:
        ...
        self.terminateConversion_label = ttk.Label(self.frame0, text="Terminate conversion:")
        ...
        self.terminateTime_label = ttk.Label(self.frame0, text="Terminate time:")
        ...
        self.terminateTime_check.grid(row=14, column=8, padx=5, pady=5, sticky='nswe')

        # Create terminateRate checkbox and entry boxes
        self.terminateRate_label = ttk.Label(self.frame0, text="Terminate rate:")
        ...
        self.terminateRate_check.grid(row=16, column=8, padx=5, pady=5, sticky='nswe')
